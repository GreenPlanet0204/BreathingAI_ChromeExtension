  ...
  return (
    ...
    >
      <h2 id="accordion-collapse-heading-1" className="w-full">
        ...
        >
          <span>{t('why_tint_my_screen')}</span>
          ...
          <p className="mb-2 text-gray-500 dark:text-white">
            <span>
              <Trans i18nKey={'description'}>
                Color has the power to affect your everyday mood and behavior.
                Tint your screen and adjust the opacity to your liking in order
                to reduce eye strain, decrease stress levels, and increase
                productivity.{' '}
                <a
                  href="https://breathing.ai/Blog/Finding-your-hearts-most-calming-hues"
                  target="_blank"
                  rel="noreferrer"
                  className="underline"
                >
                  Learn more about color perception and color therapy
                </a>
              </Trans>
            </span>
          </p>
